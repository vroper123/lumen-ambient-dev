...
if ( ! class_exists( 'lumenWP_Typography_Customizer' ) ) :

	class lumenWP_Typography_Customizer {
		...
		public function __construct() {
			...
			if ( is_customize_preview() ) {
				...
				add_filter( 'lumen_head_css', 		array( $this, 'head_css' ), 99 );
			}
		...
		public function elements() {
			...
			// Return settings
			return apply_filters( 'lumen_typography_settings', array(
				'body' 						=> array(
					'label' 				=> esc_html__( 'Body', 'lumen' ),
					'target' 				=> 'body',
					'defaults' 				=> array(
						'font-size' 		=> '14px',
						'color' 			=> '#929292',
				...
				'headings' 					=> array(
					'label' 				=> esc_html__( 'All Headings', 'lumen' ),
					'target' 				=> 'h1,h2,h3,h4,h5,h6,.theme-heading,.widget-title,.lumen-widget-recent-posts-title,.comment-reply-title,.entry-title,.sidebar-box .widget-title',
				...
				'heading_h1' 				=> array(
					'label' 				=> esc_html__( 'Heading 1 (H1)', 'lumen' ),
					'target' 				=> 'h1',
					'defaults' 				=> array(
						'font-size' 		=> '23px',
						'color' 			=> '#333333',
				...
				'heading_h2' 				=> array(
					'label' 				=> esc_html__( 'Heading 2 (H2)', 'lumen' ),
					'target' 				=> 'h2',
					'defaults' 				=> array(
						'font-size' 		=> '20px',
						'color' 			=> '#333333',
				...
				'heading_h3' 				=> array(
					'label' 				=> esc_html__( 'Heading 3 (H3)', 'lumen' ),
					'target' 				=> 'h3',
					'defaults' 				=> array(
						'font-size' 		=> '18px',
						'color' 			=> '#333333',
				...
				'heading_h4' 				=> array(
					'label' 				=> esc_html__( 'Heading 4 (H4)', 'lumen' ),
					'target' 				=> 'h4',
					'defaults' 				=> array(
						'font-size' 		=> '17px',
						'color' 			=> '#333333',
				...
				'top_menu' 					=> array(
					'label' 				=> esc_html__( 'Top Bar', 'lumen' ),
				...
				'menu' 						=> array(
					'label' 				=> esc_html__( 'Main Menu', 'lumen' ),
					'target' 				=> '#site-navigation-wrap .dropdown-menu > li > a,#site-header.full_screen-header .fs-dropdown-menu > li > a,#site-header.top-header #site-navigation-wrap .dropdown-menu > li > a,#site-header.center-header #site-navigation-wrap .dropdown-menu > li > a,#site-header.medium-header #site-navigation-wrap .dropdown-menu > li > a,.lumen-mobile-menu-icon a',
				...
				'menu_dropdown' 			=> array(
					'label' 				=> esc_html__( 'Main Menu: Dropdowns', 'lumen' ),
				...
				'page_title' 				=> array(
					'label' 				=> esc_html__( 'Page Title', 'lumen' ),
					...
					'active_callback' 		=> 'lumenwp_cac_has_page_header',
				),
				'page_subheading' 			=> array(
					'label' 				=> esc_html__( 'Page Title Subheading', 'lumen' ),
				...
				'blog_entry_title' 			=> array(
					'label' 				=> esc_html__( 'Blog Entry Title', 'lumen' ),
				...
				'blog_post_title' 			=> array(
					'label' 				=> esc_html__( 'Blog Post Title', 'lumen' ),
				...
				'sidebar_widget_title' 		=> array(
					'label' 				=> esc_html__( 'Sidebar Widget Heading', 'lumen' ),
				...
				'footer_widget_title' 		=> array(
					'label' 				=> esc_html__( 'Footer Widget Heading', 'lumen' ),
				...
				'copyright' 				=> array(
					'label' 				=> esc_html__( 'Footer Copyright', 'lumen' ),
				...
				'footer_menu' 				=> array(
					'label' 				=> esc_html__( 'Footer Menu', 'lumen' ),
		...
		public function customizer_options( $wp_customize ) {
			...
			// Panel
			$wp_customize->add_panel( 'lumen_typography_panel' , array(
				'title' 			=> esc_html__( 'Typography', 'lumen' ),
				'priority' 			=> 210,
			) );
			 ...
			 * Section
			 */
			$wp_customize->add_section( 'lumen_typography_general' , array(
				'title' 			=> esc_html__( 'General', 'lumen' ),
				'priority' 			=> 1,
				'panel' 			=> 'lumen_typography_panel',
			) );

			/**
			 * Disable Google Fonts
			 */
			$wp_customize->add_setting( 'lumen_disable_google_font', array(
				'transport' 			=> 'postMessage',
				'default'           	=> false,
				'sanitize_callback' 	=> 'lumenwp_sanitize_checkbox',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'lumen_disable_google_font', array(
				'label'	   				=> esc_html__( 'Disable Google Fonts', 'lumen' ),
				'type' 					=> 'checkbox',
				'section'  				=> 'lumen_typography_general',
				'settings' 				=> 'lumen_disable_google_font',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Font Subsets
			 */
			$wp_customize->add_setting( 'lumen_google_font_subsets' , array(
				'default' 			=> array( 'latin' ),
				'sanitize_callback' => 'lumenwp_sanitize_multicheck',
			) );

			$wp_customize->add_control( new lumenWP_Customize_Multicheck_Control( $wp_customize, 'lumen_google_font_subsets', array(
				'label' 			=> esc_html__( 'Font Subsets', 'lumen' ),
				'section' 			=> 'lumen_typography_general',
				'settings' 			=> 'lumen_google_font_subsets',
				'priority' 			=> 10,
				'choices' 			=> array(
					'latin' 		=> 'latin',
					'latin-ext' 	=> 'latin-ext',
			...
			foreach( $elements as $element => $array ) {
				...
				if ( $label ) {
					 ...
					 * Section
					 */
					$wp_customize->add_section( 'lumen_typography_'. $element , array(
						'title' 	=> $label,
						'priority' 	=> $count,
						'panel' 	=> 'lumen_typography_panel',
					) );
					...
					if ( in_array( 'font-family', $attributes ) ) {
						...
						$wp_customize->add_control( new lumenWP_Customizer_Typography_Control( $wp_customize, $element .'_typography[font-family]', array(
								'label' 			=> esc_html__( 'Font Family', 'lumen' ),
								'section' 			=> 'lumen_typography_'. $element,
					...
					if ( in_array( 'font-weight', $attributes ) ) {
						...
						$wp_customize->add_control( $element .'_typography[font-weight]', array(
							'label' 			=> esc_html__( 'Font Weight', 'lumen' ),
							'description' 		=> esc_html__( 'Important: Not all fonts support every font-weight.', 'lumen' ),
							'section' 			=> 'lumen_typography_'. $element,
							...
							'choices' 			=> array(
								...
								'100' => esc_html__( 'Thin: 100', 'lumen' ),
								'200' => esc_html__( 'Light: 200', 'lumen' ),
								'300' => esc_html__( 'Book: 300', 'lumen' ),
								'400' => esc_html__( 'Normal: 400', 'lumen' ),
								'500' => esc_html__( 'Medium: 500', 'lumen' ),
								'600' => esc_html__( 'Semibold: 600', 'lumen' ),
								'700' => esc_html__( 'Bold: 700', 'lumen' ),
								'800' => esc_html__( 'Extra Bold: 800', 'lumen' ),
								'900' => esc_html__( 'Black: 900', 'lumen' ),
							),
						) );
					}
					...
					if ( in_array( 'font-style', $attributes ) ) {
						...
						$wp_customize->add_control( $element .'_typography[font-style]', array(
							'label' 			=> esc_html__( 'Font Style', 'lumen' ),
							'section' 			=> 'lumen_typography_'. $element,
							...
							'choices' 			=> array(
								...
								'italic' => esc_html__( 'Italic', 'lumen' ),
							),
						) );
					...
					if ( in_array( 'text-transform', $attributes ) ) {
						...
						$wp_customize->add_control( $element .'_typography[text-transform]', array(
							'label' 			=> esc_html__( 'Text Transform', 'lumen' ),
							'section' 			=> 'lumen_typography_'. $element,
							...
							'choices' 			=> array(
								'' 			 => esc_html__( 'Default', 'lumen' ),
								'capitalize' => esc_html__( 'Capitalize', 'lumen' ),
								'lowercase'  => esc_html__( 'Lowercase', 'lumen' ),
								'uppercase'  => esc_html__( 'Uppercase', 'lumen' ),
					...
					if ( in_array( 'font-size', $attributes ) ) {
						...
						$wp_customize->add_control( new lumenWP_Customizer_Text_Control( $wp_customize, $element .'_typography[font-size]', array(
							'label' 			=> esc_html__( 'Font Size', 'lumen' ),
							'description' 		=> esc_html__( 'You can add: px-em-%', 'lumen' ),
							'section' 			=> 'lumen_typography_'. $element,
							'settings' 			=> array(
					...
					if ( in_array( 'line-height', $attributes ) ) {
						...
						$wp_customize->add_control( new lumenWP_Customizer_Slider_Control( $wp_customize, $element .'_typography[line-height]', array(
							'label' 			=> esc_html__( 'Line Height', 'lumen' ),
							'section' 			=> 'lumen_typography_'. $element,
							'settings' 			=> array(
					...
					if ( in_array( 'letter-spacing', $attributes ) ) {
						...
						$wp_customize->add_control( new lumenWP_Customizer_Slider_Control( $wp_customize, $element .'_typography[letter-spacing]', array(
							'label' 			=> esc_html__( 'Letter Spacing (px)', 'lumen' ),
							'section' 			=> 'lumen_typography_'. $element,
							'settings' 			=> array(
					...
					if ( in_array( 'font-color', $attributes ) ) {
						...
						$wp_customize->add_control( new lumenWP_Customizer_Color_Control( $wp_customize, $element .'_typography[color]', array(
							'label' 			=> esc_html__( 'Font Color', 'lumen' ),
							'section' 			=> 'lumen_typography_'. $element,
		...
		public function customize_preview_init() {
			wp_enqueue_script( 'lumen-typography-customize-preview',  LumenWP_INC_DIR_URI . 'customizer/assets/js/typography-customize-preview.min.js', array( 'customize-preview' ), lumenWP_THEME_VERSION, true );
			wp_localize_script( 'lumen-typography-customize-preview', 'lumen', array(
		...
		public function load_fonts() {
			...
			if ( ! empty( $fonts ) && is_array( $fonts ) ) {
				foreach ( $fonts as $font ) {
					lumenwp_enqueue_google_font( $font );
				}
			}
...
return new lumenWP_Typography_Customizer();