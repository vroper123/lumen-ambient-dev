wp.customize.controlConstructor['lumen-range'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		jQuery( 'input[type=range]' ).on( 'mousedown', function() {
			...
			range 			= jQuery( this );
			range_input 	= range.parent().children( '.lumen-range-input' );
		...
		jQuery( 'input.lumen-range-input' ).on( 'change keyup', function() {
		...
		jQuery( '.lumen-reset-slider' ).on('click', function() {
