<?php
/**
 * Customizer Control: lumen-slider.
 *
 ...
 * Buttonset control
 */
class LumenWP_Customizer_Slider_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'lumen-slider',  LumenWP_INC_DIR_URI . 'customizer/assets/min/js/slider.min.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), false, true );
		wp_enqueue_style( 'lumen-slider',  LumenWP_INC_DIR_URI . 'customizer/assets/min/css/slider.min.css', null );
	}
	...
	protected function content_template() {
		...
		<# if ( data.desktop ) { #>
			<div class="desktop control-wrap active">
				<div class="lumen-slider desktop-slider"></div>
				<div class="lumen-slider-input">
		...
		<# if ( data.tablet ) { #>
			<div class="tablet control-wrap">
				<div class="lumen-slider tablet-slider"></div>
				<div class="lumen-slider-input">
		...
		<# if ( data.mobile ) { #>
			<div class="mobile control-wrap">
				<div class="lumen-slider mobile-slider"></div>
				<div class="lumen-slider-input">
