...
class Editor {
	...
	public static function settings_advanced( $settings ) {
		...
		$styles = [
			...
			array(
				'title'     => __('Text: Cross out','lumen-ambient'),
				'inline'    => 'span',
			...
			*/
			...
			array(
				'title'     => __('Image: 50% Width','lumen-ambient'),
				'selector'  => 'img',
				'classes'   => 'half-width',
			),
			*/
			...
			array(
				'title'     => __('Warning Box','lumen-ambient'),
				'block'     => 'div',
				'classes'   => 'warning box',
				'exact'     => true,
				'wrapper'   => true,
			...
			*/
			...
			array(
				'title'     => __('Red Uppercase Text','lumen-ambient'),
				'inline'    => 'span',
				'styles'    => array(
					'color'         => '#ff0000',
					'fontWeight'    => 'bold',
			...
			*/
			...
			[
				'title'   => __( 'Section', 'lumen-ambient' ),
				'block'   => 'section',
				'wrapper' => true,
				'exact'   => true,
			],
			[
				'title'   => __( 'Foundation Row', 'lumen-ambient' ),
				'block'   => 'div',
				'classes' => 'row',
				'wrapper' => true,
				'exact'   => true,
			...
			[
				'title'   => __( 'Column (Small 12)', 'lumen-ambient' ),
				'block'   => 'div',
			...
			[
				'title'   => __( 'Column (Small 6)', 'lumen-ambient' ),
				'block'   => 'div',
			...
			[
				'title'    => __( 'Medium 2 (Edit Column)', 'lumen-ambient' ),
				'selector' => '.columns',
				'classes'  => 'medium-2',
			],
			[
				'title'    => __( 'Medium 4 (Edit Column)', 'lumen-ambient' ),
				'selector' => '.columns',
				'classes'  => 'medium-4',
			],
			[
				'title'    => __( 'Medium 6 (Edit Column)', 'lumen-ambient' ),
				'selector' => '.columns',
				'classes'  => 'medium-6',
			],
