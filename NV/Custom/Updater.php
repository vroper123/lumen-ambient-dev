...
/**
 * This class provides update
 * 
 */
class Updater {
/* Automagical updates */
public static function wupdates_check_Mojwm( $transient ) {
	...
	$w=array();$re="";$s=array();$sa=md5('32824395fbb6bd63f9a42f446a20094e5020414d');
	...
	$url = $http_url = set_url_scheme( 'https://wupdates.com/wp-json/wup/v1/themes/check_version/Mojwm', 'http' );
...
public static function wupdates_add_id_Mojwm( $ids = array() ) {
	// First get the theme directory name (unique)
	$slug = basename( get_template_directory() );

	// Now add the predefined details about this product
	// Do not tamper with these please!!!
	$ids[ $slug ] = array( 'name' => 'Lumen Ambient', 'slug' => 'lumen-ambient', 'id' => 'Mojwm', 'type' => 'theme', 'digest' => '578d5d7c8d20822cb372e2920d67292a', );
