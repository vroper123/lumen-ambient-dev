...
if ( post_password_required() ) {
    echo '<p>'.__( 'This post is password protected. Enter the password to view comments.', 'lumen-ambient' ).'</p>';
    return;
}

if ( have_comments() ) { ?>

    <h3><?php _e('Comments', 'lumen-ambient' ) ?></h3>
    <p>
    <?php
    printf(
        _n(
...
else
{
    ...
    if ( comments_open() ) {
        ...
        echo '<p>'.__( 'Comments are closed.', 'lumen-ambient' ).'</p>';
    }
}
